...
#define SHARED_MEMORY_KEY "/tmp/sysvshm_test/shared_memory_key"
#define SEM_MUTEX_KEY "/tmp/sysvshm_test/sem-mutex-key"
#define SEM_BUFFER_COUNT_KEY "/tmp/sysvshm_test/sem-buffer-count-key"
#define SEM_SPOOL_SIGNAL_KEY "/tmp/sysvshm_test/sem-spool-signal-key"
#define PROJECT_ID 'K'
